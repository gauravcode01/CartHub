...
if ($price <= 0 || $stock <= 0) {
    $message = '<div class="alert alert-danger border-0 shadow-sm">
                    ...
                    Price and Inventory must be greater than 0!
                </div>';
    $uploadOk = 0;
}
...
<nav class="navbar navbar-expand-lg seller-nav sticky-top shadow-sm">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold text-primary" href="index.php"><i class="fas fa-store me-2"></i>CartHub</a>
...
class="form-control price-input no-spinner" placeholder="0.00" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Inventory Count</label>
                                   <input type="number" min="1" name="stock" 
class="form-control no-spinner" placeholder="Available units" required>
                                </div>
                            </div>
