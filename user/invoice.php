...
/* ✅ FETCH ADDRESS (FROM ORDERS TABLE) */
            ...
            <!-- <div class="col-6">
                ...
                <p class="small">
                    ...
                    <?php if($delivery_phone): ?>
                        <strong>Phone:</strong> <?php echo htmlspecialchars($delivery_phone); ?>
                    <?php endif; ?>
                </p>
            </div> -->
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <th class="text-end">₹<?php echo number_format($gst, 2); ?></th>
                </tr>

                <tr>
                    <th colspan="3" class="text-end fw-bold">Final Total</th>
                    <th class="text-end text-primary fw-bold">₹<?php echo number_format($final_total, 2); ?></th>
                </tr>
            </tfoot>
        </table>
