...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['slide_img'])) {
    ...
    if (move_uploaded_file($_FILES["slide_img"]["tmp_name"], $target_file)) {
        ...
        $message = '<div class="alert alert-danger border-0 shadow-sm rounded-4"><i class="fas fa-exclamation-circle me-2"></i>Upload failed. Please check folder permissions.</div>';
    }
}
