...
<div class="container-fluid p-0">
    <div class="row g-0"> 
        ...
        <!-- ✅ DIRECT SIDEBAR (NO EXTRA WRAPPER) -->
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-3 fw-bold text-dark" style="font-size: 0.8rem;">
                                    ₹<?php echo number_format($user['total_volume'], 0); ?>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
...
new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [
            ...
            {
                label: 'Sellers',
                data: <?php echo json_encode($seller_data); ?>,
